...
function Weather() {
    ...
    useEffect(() => {
        fetchWeatherData(defaultCity, setCityWeather);
    }, []);
            ...
            return (
                <Card sx={{ display: "flex" }}>
                    ...
                    <CardContent sx={{ flex: "1 0 auto" }}>
                        <Typography component="div" variant="h5">{weather.name}</Typography>
                        <Typography component="div" variant="subtitle1">{weather.main.temp}&#8451;</Typography>
                    </CardContent>
                </Card>
            );
        } else {
    ...
    return (
        <Box sx={{ ml: 10, mr: 10, mt: 1, mb: 1, backgroundColor: "lightgray" }}>
            <Stack direction="row" spacing={2}>
                ...
                <Box>
                    <TextField placeholder="Another city"></TextField>
